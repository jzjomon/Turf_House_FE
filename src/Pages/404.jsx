            ...
            <div class="h-screen w-screen bg-gray-50 flex items-center">
                <div class="container flex flex-col md:flex-row items-center justify-between px-5 text-gray-700">
                    <div class="w-full lg:w-1/2 mx-8">
                        ...
                        <div onClick={() => navigate("/")} class="px-5 cursor-pointer inline py-3 text-sm font-medium leading-5 shadow-2xl text-white transition-all duration-400 border border-transparent rounded-lg focus:outline-none bg-green-600 active:bg-white hover:bg-white hover:border hover:border-green-600 hover:text-green-600 hover:font-bold ">back to homepage</div>
                    </div>
